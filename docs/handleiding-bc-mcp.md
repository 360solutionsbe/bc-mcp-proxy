...
- **Wat het oplevert**: je vraagt Claude (of een andere AI client) "*toon me de top 10 klanten in CRONUS USA op openstaand saldo*" en hij haalt die data live uit **jouw** BC environment via een veilige, geauthenticeerde verbinding. Geen export, geen kopieerwerk, geen tussenstap.
...
- *"Toon me de top 5 klanten in CRONUS USA."*
